...
def load_data(dataset):
    ...
    x = numpy.array(test_set[0])
    print(x.shape)

    x = numpy.array(valid_set[0])
    print(x.shape)
...
def sgd_optimization_mnist(learning_rate=0.13, n_epochs=10000,
    ...
    classifier = LogisticRegression(input=x, n_in=88, n_out=10)
